...
import org.task.bank.CurrencyDebitCard;
...
class CurrencyDebitCardTest {
    ...
    void deposit() {
        ...
        assertTrue(currencyDebitCard.getBalance().equals(new BigDecimal(1100)));
    ...
    void debitingFunds() {
        ...
        assertTrue(currencyDebitCard.getBalance().equals(new BigDecimal(900)));
